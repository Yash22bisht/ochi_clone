...
function cards() {
  return (
    <div data-scroll-section  className="w-screen h-[90vh] overflow-hidden max-sm:h-full ">
    <div data-scroll data-scroll-speed="-0.6"  className='w-screen h-[90vh] pt-6 px-20 bg-white flex gap-6 max-sm:px-5   max-sm:flex-wrap  '>
        <div className="card1 w-[46vw] h-[55vh] bg-[#004D43] rounded-xl flex justify-center items-center  relative max-sm:w-[90vw] max-sm:h-[42vh]">
        ...
        <div className="card2 w-[25vw] h-[55vh] bg-[#212121] rounded-xl flex justify-center items-center  relative max-sm:w-[90vw] max-sm:h-[42vh]">
        ...
        <div className="card2 w-[23vw] h-[55vh] bg-[#212121] rounded-xl flex justify-center items-center  relative max-sm:w-[90vw] max-sm:h-[42vh]">
