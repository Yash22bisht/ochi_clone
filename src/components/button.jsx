...
function button(props) {
  ...
  return (
    <button onMouseEnter={()=>{setHover(true)}} onMouseLeave={()=>{setHover(false)}} className="px-6 py-4 rounded-[8vw] text-md bg-black text-white flex items-center gap-5  relative">
      {props.value}
